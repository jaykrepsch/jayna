...
function updateBaseEntityFile(filePath) {
  ...
  "jaynaApp.base${entityType}.organisation.table.empty": "Keine Kalender-Einträge, Aufgaben oder Notizen vorhanden"`;
      ...
      updatedContent = updatedContent.replace(
        ...
        `"jaynaApp.base${entityType}.organisation.placeholder": "Hier werden später Kalender, Aufgaben und Notizen angezeigt"${organisationTableTranslations}`
      );
    }

    // Übersetzungen für Dokumente hinzufügen
    if (!updatedContent.includes(`jaynaApp.base${entityType}.documents.table.category`)) {
      const documentsTableTranslations = `,
  ...
  "jaynaApp.base${entityType}.documents.table.empty": "Keine verknüpften Dokumente vorhanden"`;
      ...
      updatedContent = updatedContent.replace(
        ...
        `"jaynaApp.base${entityType}.documents.placeholder": "Hier werden später die verknüpften Dokumente angezeigt"${documentsTableTranslations}`
      );
    }
