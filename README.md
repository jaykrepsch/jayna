Full tailwind build:
npx tailwindcss-cli -i ./src/main/webapp/content/css/input.css -o ./src/main/webapp/content/css/index.css --watch
Normal tailwind build:
npx tailwindcss -i ./src/main/webapp/content/css/input.css -o ./src/main/webapp/content/css/index.css --watch

Applikation start for debugging:
./mvnw -Dspring-boot.run.jvmArguments="-Xdebug -Xrunjdwp:transport=dt_socket,server=y,suspend=y,address=5005"

# jayna

jhipster create new entity:

jhipster jdl <entity-file>.jdl --skip-db-changelog
...
To build the final jar and optimize the jayna application for production, run:
