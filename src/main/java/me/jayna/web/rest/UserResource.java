...
import me.jayna.web.rest.errors.EmailAlreadyUsedException;
import me.jayna.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
  ...
  public ResponseEntity<Void> deleteUser(@PathVariable @Pattern(regexp = Constants.LOGIN_REGEX) String login) {
    ...
    return ResponseEntity.noContent().headers(HeaderUtil.createAlert(applicationName, "userManagement.deleted", login))
        .build();
  }
}
