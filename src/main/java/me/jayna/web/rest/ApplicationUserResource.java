...
/**
 * REST controller for managing {@link me.jayna.domain.ApplicationUser}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ApplicationUserResource {
   ...
   *         body the new applicationUser, or with status
   ...
   *         the updated applicationUser,
   *         or with status {@code 400 (Bad Request)} if the applicationUser is
   *         not valid,
   *         or with status {@code 500 (Internal Server Error)} if the
   *         applicationUser couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/application-users/{id}")
  public ResponseEntity<ApplicationUser> updateApplicationUser(
      @PathVariable(value = "id", required = false) final Long id,
      @RequestBody ApplicationUser applicationUser) throws URISyntaxException {
   ...
   *         or with status {@code 400 (Bad Request)} if the applicationUser is
   *         not valid,
   *         or with status {@code 404 (Not Found)} if the applicationUser is not
   *         found,
   *         or with status {@code 500 (Internal Server Error)} if the
   *         applicationUser couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   ...
   * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
   *         the applicationUser, or with status {@code 404 (Not Found)}.
   */
