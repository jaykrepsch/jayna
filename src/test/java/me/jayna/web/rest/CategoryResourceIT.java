...
class CategoryResourceIT {
  ...
  void createCategory() throws Exception {
    ...
    assertThat(testCategory.getTranslationKey())
        .isEqualTo(DEFAULT_TRANSLATION_KEY);
    assertThat(testCategory.getEntityName()).isEqualTo(DEFAULT_ENTITY_NAME);
  }
  ...
  void putNewCategory() throws Exception {
    ...
    Category updatedCategory = categoryRepository
        ...
        .orElseThrow();
    // Disconnect from session so that the updates on updatedCategory are not
    ...
    assertThat(testCategory.getEntityName()).isEqualTo(UPDATED_ENTITY_NAME);
  }
  ...
  void partialUpdateCategoryWithPatch() throws Exception {
    ...
    partialUpdatedCategory.name(UPDATED_NAME).entityName(UPDATED_ENTITY_NAME);
