...
import static me.jayna.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
class AccountResourceIT {
  ...
  void testRegisterAdminIsIgnored() throws Exception {
    ...
    assertThat(userDup.orElseThrow().getAuthorities())
        .hasSize(1)
        .containsExactly(authorityRepository.findById(AuthoritiesConstants.ROLE_USER_BASIC).orElseThrow());
  }
